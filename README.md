About langfuse-python-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/langfuse-python-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/langfuse-python-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add langfuse-python
# for installing globally
pixi global install langfuse-python
```
...
It is possible to list all of the versions of `langfuse-python` available on your platform:
...
```
pixi search langfuse-python --channel conda-forge
```
